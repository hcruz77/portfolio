    ...
    <>
      <div style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' }}>
        <div className="container-fluid p-5 min-vh-100">
          ...
          <div className="card w-50 bg-light bg-opacity-50 text-dark border border-gray shadow">
            <div className="card-body">
              ...
              <a href="mailto:chance.heather@gmail.com" className="card-link">email me</a>
            </div>
          </div>
